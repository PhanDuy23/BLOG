...
<body>
    ...
    <div class="body" style="display: flex; flex-direction: column; align-items: center; ">
        ...
        <div class="container" style="display: flex; width: 70%; ">
            <div class="sidebar" style="display: flex; flex-direction: column;border-right: 3px solid rgb(197, 192, 192);">
            ...
            <div class="content">
                ...
                <c:forEach var="o" items="${likedPosts}">
                    <div class="post" style="display: flex;">
                        <img alt="image of post" height="auto" src="${o.pimage}" width="30%" />
...
<!--            <div class="content">
    ...
    <div class="footer" style="display: flex; justify-content: center; border-top: 2px solid rgb(189, 181, 181);">
