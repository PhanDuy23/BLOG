    ...
    <div class="body" style="display: flex; flex-direction: column; align-items: center; ">
        ...
        <div class="container" style="display: flex; width: 70%; ">
            ...
            <div class="content">
                ...
                <div class="info-item">
                    <div><i class="fas fa-user"></i> Họ và tên</div>
                ...
                <div class="info-item">
                    <div> <i class="fas fa-key"></i> Mật khẩu</div>
                    <input style="border-radius: 6px;" type="password" value="${sessionScope.user.upassword}" id="pass">
                    <span onclick="togglePass()"><i class="fa-solid fa-eye"></i></span>
                </div>
                <!-- <div class="info-item"> <i class="fas fa-birthday-cake"></i>
