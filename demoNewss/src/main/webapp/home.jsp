...
<body >
    <div class="header">
        <img src="https://theme.hstatic.net/200000333665/1000707799/14/blog_news_banner.png?v=296" alt="ảnh" style="width: 100%; height: auto;">
    </div>
    ...
    <div class="footer" style="display: flex; justify-content: center; border-top: 2px solid rgb(202, 194, 194);">
